...
const Experience = () => {
    return (
      <>
    <div className="container"><h4>Herramientas de Frontend</h4></div>
    <section className="experiencia-container">
      <div className="item-experiencia"><img src={html5} alt="HTML5" title="HTML5" /></div>
      <div className="item-experiencia"><img src={css3} alt="CSS3" title="CSS3" /></div>
      <div className="item-experiencia"><img src={js} alt="JavaScript" title="JavaScript" /></div>
    ...
    <section className="experiencia-container">
      <div className="item-experiencia"><img src={ReactBootstrap} alt="React Bootstrap" title="React Bootstrap" /></div>
